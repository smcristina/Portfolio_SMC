...
const externals = require("xlsx-populate/lib/externals");
const regexify = require("xlsx-populate/lib/regexify");
const blank = require("xlsx-populate/lib/blank")();
const xmlq = require("xlsx-populate/lib/xmlq");
const Sheet = require("xlsx-populate/lib/Sheet");
const ContentTypes = require("xlsx-populate/lib/ContentTypes");
const AppProperties = require("xlsx-populate/lib/AppProperties");
const CoreProperties = require("xlsx-populate/lib/CoreProperties");
const Relationships = require("xlsx-populate/lib/Relationships");
const SharedStrings = require("xlsx-populate/lib/SharedStrings");
const StyleSheet = require("xlsx-populate/lib/StyleSheet");
...
const ArgHandler = require("xlsx-populate/lib/ArgHandler");
const addressConverter = require("xlsx-populate/lib/addressConverter");
